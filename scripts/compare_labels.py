...
# Durch open öffnen wir den Datei-Inhalt. Mit .read() lesen wir den gesamten Inhalt
# von blind.jsonl und geben ihn zurück.
...
# Jetzt können wir vergleichen ob die Anzahl an Zeilen stimmt & in wie vielen Labels
# wir das gleiche getippt haben
